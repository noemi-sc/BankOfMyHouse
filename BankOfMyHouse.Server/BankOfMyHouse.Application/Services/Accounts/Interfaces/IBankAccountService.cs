...
namespace BankOfMyHouse.Application.Services.Accounts.Interfaces
{
	public interface IBankAccountService
	{
		...
		Task<IEnumerable<Transaction>> GetTransactions(Domain.Users.User user, string iban, CancellationToken ct, DateTimeOffset? startDate = null, DateTimeOffset? endDate = null);
	}
}
